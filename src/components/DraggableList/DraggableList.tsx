    ...
    >
      {listedData.map((data, index) => (
        <div
          ...
          <div className="card-listagem mt-4 rounded-[10px] border-[3px] border-brand-accent p-4">
            <div className="flex gap-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="card-listagem-text text-black">
                  <p className="mb-1 font-bold">{data[labelTitle]}</p>
                  <p className="mb-0 text-sm">{data[labelSubtitle]?.length > 150 ? data[labelSubtitle].substring(0, 150) + '...' : data[labelSubtitle]}</p>
                </div>
              </div>
            </div>
          </div>
