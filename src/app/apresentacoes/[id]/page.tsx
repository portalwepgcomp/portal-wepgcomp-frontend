...
export default function ApresentacaoDetalhes() {
  ...
  const handleDownloadPdf = () =>
    baixarPdf(presentation?.submission?.id, presentation?.submission?.pdfFile);
    ...
    return (
      <div className="flex min-h-[400px] flex-col items-center justify-center gap-6">
        ...
        <p className="text-foreground">
          Carregando detalhes da apresentação...
        </p>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-[400px] flex-col items-center justify-center gap-6">
        ...
        <p className="text-muted">
          Não foi possível carregar os detalhes desta apresentação.
        </p>
    ...
    <>
      ...
      <div className="mx-auto max-w-[900px] px-5 py-10">
        ...
        <div className="mt-8 flex flex-col gap-8">
            ...
            <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-full bg-brand-blue">
              {presentation.submission?.mainAuthor?.photoFilePath ? (
                <Image
                  ...
                  alt={
                    presentation.submission.mainAuthor.name || "Foto do autor"
                  }
                  width={80}
                  height={80}
          ...
          <div className="rounded-xl border border-line bg-card p-6">
            <h3 className="mb-5 text-xl font-bold text-brand-navy">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-5 max-md:grid-cols-1">
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="m-0 text-base text-[#1a1a1a]">
                    {formatDate(presentation.presentationTime || "")}
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="m-0 text-base text-[#1a1a1a]">
                    {formatOnlyTime(presentation.presentationTime || "")}
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
